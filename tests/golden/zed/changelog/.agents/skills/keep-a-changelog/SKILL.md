...
description: Use when writing or updating a CHANGELOG. Applies the Keep a Changelog format — the six change groups (Added, Changed, Deprecated, Removed, Fixed, Security), reverse-chronological version blocks, ISO dates, and an Unreleased section — kept aligned with Semantic Versioning.
---
