...
- Follow RBS-inline syntax conventions strictly
  - See [syntax.md](references/syntax.md) for the full RBS-inline syntax guide
- Pay extra attention to `Data` and `Struct` types
  - See [data-struct-support.md](references/data-struct-support.md) for Data and Struct handling
...
- [syntax.md](references/syntax.md) - RBS-inline syntax guide
