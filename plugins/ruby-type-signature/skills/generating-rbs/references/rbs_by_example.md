...
- [Goal](#goal)
- [Examples](#examples)
  - [Zero argument methods](#zero-argument-methods)
  - [Single argument methods](#single-argument-methods)
  - [Variable argument methods](#variable-argument-methods)
  - [Optional positional arguments](#optional-positional-arguments)
  - [Multiple signatures for a single method](#multiple-signatures-for-a-single-method)
