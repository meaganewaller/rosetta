...
| Understand a specific harness adapter | [Cursor](adapters/cursor.md) · [Codex CLI](adapters/codex.md) · [OpenCode](adapters/opencode.md) · [Gemini CLI](adapters/gemini.md) |
